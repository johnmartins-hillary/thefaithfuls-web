...
import {
        ...
        Textarea,Text,Box} from "@chakra-ui/react"
import {Button} from "components/Button"
import NormalInput from "components/Input/Normal"
import {GoBackButton} from "components/GoBackButton"
import {createNewGroup} from "store/Group/actions"
...
const Create = () => {
    ...
    const handleSubmit = (values: IForm, {...actions}: any) => {
        ...
        // const addMemberToGroup = (values:IGroup,cb:any) => {
        //     const newGroupsMember = selectedMember.map((item,idx) => (
        //         {
        //             societies:[values.societyID!],
        //             churchId:Number(params.churchId),
        //             societyPosition:[2],
        ...
        //     }
        // }
        dispatch(createNewGroup(newGroup,toast,() => {actions.setSubmitting(false)}))
    }
    ...
    return (
        <VStack pl={{ base:2, md: "7rem"}} pt={{ md: 6 }}
                ...
                <Formik initialValues={initialValues}
                            ...
                            >
                                {(formikProps: FormikProps<IForm>) => (
                                        <>
                                        <VStack alignSelf="flex-start" className={classes.inputContainer} maxW="md">
                                            <HStack>
                                        ...
                                        <HStack spacing={2} width="100%" my={{base:5,md:12}}>
